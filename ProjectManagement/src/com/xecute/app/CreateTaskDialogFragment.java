...
/**
 */
public class CreateTaskDialogFragment extends DialogFragment implements
	...
	public interface CreateTaskDialogListener {
		public void onTaskCreate(String taskNameStr, Date date,
				ArrayList<ParseUser> users, String taskDescriptionStr);
	}
	...
	public void saveTaskData() {
		...
		mCallback.onTaskCreate(taskNameStr, date, this.taskedUsers,
				taskDescriptionStr);
	}
